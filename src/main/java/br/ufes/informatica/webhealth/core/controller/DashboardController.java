...
public class DashboardController extends CrudController<Ocorrencia> {
	...
	public void filtrar() {
		...
		List<Ocorrencia> ocorrenciasPorSintomas = filtroService.filtrarPorDoenças(listaNomeDoencas, cidade, estado);
		List<Ocorrencia> ocorrenciasPorRemedios = filtroService.filtrarPorRemedios(remedios, cidade, estado);
		List<Ocorrencia> ocorrenciasPorDoencas = filtroService.filtrarPorSintomas(sintomas, cidade, estado);
		criaCharts();
	...
	public void setDoencasChart(LineChartModel tratamentoChart) {
		this.doencasChart = tratamentoChart;
	}
	...
	private LineChartModel criaChartLine(List<Ocorrencia>ocorrencias) {
        ...
        yAxis.setMin(0);
        yAxis.setLabel("Qtde Ocorrências");
        yAxis.setMax(10000);
